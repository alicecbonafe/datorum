...
def test_registry():
    ...
    register_resource_factory(
        ...
        factory=mocked_factory_1)

    assert ResourceFactoryRegistry[resource_1_id] == mocked_factory_1
    assert get_resource(resource_id=resource_1_id, target_alias=target_alias) == mocked_factory_1(target_alias)
    ...
    assert get_resource(resource_id=resource_2_id, target_alias=target_alias) == mocked_factory_2(target_alias)
